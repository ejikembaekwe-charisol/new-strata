...
export const COMPONENT_CATALOG = [
  { key: 'button', name: 'Button', tag: 'inputs', category: 'Inputs & Forms', template: 'button', appCategory: 'Actions & Triggers', desc: 'Interactive button trigger for user actions', variants: ['primary', 'secondary', 'outline'], states: true, exact: true },
  { key: 'input', name: 'Input', tag: 'inputs', category: 'Inputs & Forms', template: 'input', appCategory: 'Forms & Inputs', desc: 'Text input fields for forms and user data collection', variants: ['default', 'filled'], states: true, exact: true },
  { key: 'card', name: 'Card', tag: 'layout', category: 'Navigation & Layout', template: 'card', appCategory: 'Layout & Containers', desc: 'Container for grouping related content and actions', variants: ['default', 'elevated'], states: false, exact: true },
  { key: 'badge', name: 'Badge', tag: 'data-display', category: 'Data Display', template: 'badge', appCategory: 'Data Display & Visualization', desc: 'Compact status or tag indicators', variants: ['default', 'success', 'warning', 'danger'], states: false, exact: true },
  { key: 'avatar', name: 'Avatar', tag: 'data-display', category: 'Data Display', template: 'image', appCategory: 'Data Display & Visualization', desc: 'Visual representation of a user or entity', variants: ['default'], states: false, exact: false },
  { key: 'alert', name: 'Alert', tag: 'feedback', category: 'Feedback & Overlays', template: 'card', appCategory: 'Layout & Containers', desc: 'Contextual feedback messages for user actions', variants: ['info', 'error'], states: false, exact: false },
  { key: 'modal', name: 'Modal', tag: 'feedback', category: 'Feedback & Overlays', template: 'modal', appCategory: 'Layout & Containers', desc: 'Overlay window for focused user tasks or notifications', variants: ['default'], states: false, exact: false },
  { key: 'toggle', name: 'Toggle Switch', tag: 'inputs', category: 'Inputs & Forms', template: 'selection', appCategory: 'Forms & Inputs', desc: 'Binary switch control for setting state on/off', variants: ['default'], states: true, exact: false },
  { key: 'select', name: 'Select Dropdown', tag: 'inputs', category: 'Inputs & Forms', template: 'dropdown', appCategory: 'Actions & Triggers', desc: 'Dropdown selector for single or multiple options', variants: ['default'], states: true, exact: false },
  { key: 'tooltip', name: 'Tooltip', tag: 'feedback', category: 'Feedback & Overlays', template: 'tooltip', appCategory: 'Actions & Triggers', desc: 'Brief contextual popover helper text', variants: ['default'], states: false, exact: false },
  { key: 'tabs', name: 'Tabs', tag: 'navigation', category: 'Navigation & Layout', template: 'tabs', appCategory: 'Layout & Containers', desc: 'Navigational tab bar for switching views', variants: ['default'], states: false, exact: false },
  { key: 'table', name: 'Table', tag: 'data-display', category: 'Data Display', template: 'table', appCategory: 'Data Display & Visualization', desc: 'Data grid for displaying structured rows and columns', variants: ['default'], states: false, exact: false },
];
